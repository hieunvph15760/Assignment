            ...
            <div class="max-w-screen-lg h-auto m-auto border-1 border-[#ededed] py-4">
                ...
                <div class="w-1/5 flex items-center">
                    <div class="flex w-32 justify-center py-2 rounded-sm">
                        <button data-id="${item.id}" class="btn btn-increase w-8 h-8 bg-[#d1ceda] rounded-sm flex items-center justify-center">+</button>
                        <input type="number" value="${item.quantity}" class="w-9 ml-3 -mt-1"/>
                        <button data-id="${item.id}" class="btn btn-decrease w-8 h-8 bg-[#d1ceda] rounded-sm flex items-center justify-center">-</button>
                    </div>
                </div>
                <div class="w-1/5 flex items-center">
                    <div class="text-[#fe4c50] font-bold">
                    ...
                    <div>
                    <button data-id="${item.id}" class="btn btn-delete rounded-md h-7 flex items-center justify-center text-white bg-red-500 p-2 ml-8"><i class="fa-solid fa-xmark"></i></button>
                    </div>
                </div>
                    `).join("")}
                </div>
